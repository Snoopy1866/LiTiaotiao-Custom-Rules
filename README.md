...
💡 如果你不知道怎么查找包名，你也可以直接在 [Releases](https://github.com/Snoopy1866/LiTiaotiao-Custom-Rules/releases) 页面搜索 app 名称快速查找。需要注意的是 app 名称可能会发生变更，而包名一般不会发生变更，因此在 Releases 页面可能无法查询到你想要的 app，此时建议通过包名查找你需要的规则。
