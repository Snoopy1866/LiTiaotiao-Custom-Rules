...
## 新增未收录 app 自定义规则
1. 根据进入包名首字母的文件夹中，如包名以 “cn”，“com” 开头，需再次进入 C 文件夹的对应 cn, com 子文件夹中，然后新建一个子文件夹，名称与包名一致；
...
## 删除已收录 app 自定义规则
<font color=red>注意：一般情况下，请勿删除已有的规则，不同版本的app，规则可能不完全一致，最大限度保留已有规则，以适用于大多数版本的 app。</font>
