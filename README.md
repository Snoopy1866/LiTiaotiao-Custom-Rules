...
⚠ **请在模板中的代码块中书写规则，以便导入规则文件的 java 程序 [ExportRules](https://github.com/Snoopy1866/LiTiaotiao-Custom-Rules/blob/main/.src/ExportRules/src/Main.java) 能够正确识别属于规则的文本。**
